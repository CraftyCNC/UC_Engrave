...
Module TextBoxFilter
    ...
    Public Sub AssignValidation(ByRef CTRL As Windows.Forms.TextBox, ByVal Validation_Type As ValidationType)
        ...
        Select Case Validation_Type
            Case ValidationType.Only_PosNumbers
                AddHandler txt.KeyPress, AddressOf number1_Leave
            Case ValidationType.Only_AllNumbers
                AddHandler txt.KeyPress, AddressOf number2_Leave
        ...
        End Select
    End Sub
    Public Sub number1_Leave(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Public Sub number2_Leave(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        Dim numbers As Windows.Forms.TextBox = sender
        If InStr("1234567890.-", e.KeyChar) = 0 And Asc(e.KeyChar) <> 8 Or (e.KeyChar = "." And InStr(numbers.Text, ".") > 0) Then
            e.KeyChar = Chr(0)
            e.Handled = True
